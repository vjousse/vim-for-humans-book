...
\begin{tabular}[H]{|c|c|}
  ...
  \tty\xspace puis \tthat & copie tout jusqu'au début de la ligne \\
  \hline
\end{tabular}
\bigskip
...
\TODO. Mode normal, mode insertion, mode visuel et mode ligne de commande.
...
\begin{figure}%
  \includegraphics[width=\linewidth]{vim-adventures.png}
