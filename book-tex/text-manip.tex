...
À partir du moment où vous aurez pris l'habitude de passer rapidement d'un mode à l'autre (et pour cela se passer de \ttesc va devenir indispensable), utiliser la souris vous apparaitra comme une perte de temps, mais pour cela il va falloir pratiquer un peu bien sur.
