...
Tout d'abord petite explication de comment on installe et configure des plugins dans \vim. Ils s'installent en copiant les fichiers adéquats (la plus part du temps du style \emph{*.vim}) dans des sous répertoire de votre répertoire de configuartion \emph{.vim}. On a déjà d'ailleurs commencé à y créer un sous répertoire colors.
